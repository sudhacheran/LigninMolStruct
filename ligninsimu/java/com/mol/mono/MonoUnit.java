...
public class MonoUnit {
	...
	public String toString() {
		...
		ss = ss.concat(",child1 [Type="+(child1 !=null?child1.getType()+", ID="+child1.getId()+",ParentID="+child1.getpID():"")+"]");
		ss = ss.concat(",child2 [Type="+(child2 !=null?child2.getType()+", ID="+child2.getId()+",ParentID="+child2.getpID():"")+"]");
		ss = ss.concat(",child3 [Type="+(child3 !=null?child3.getType()+", ID="+child3.getId()+",ParentID="+child3.getpID():"")+"]");	
