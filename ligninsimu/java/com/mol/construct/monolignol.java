...
public class monolignol {
  ...
  monolignol(String type, int idV) {
	...
	public String toString() {
		return "monolignol [type=" + type + ", child1=" + ((child1==null)?"":child1.objId+child1.getType()) + ", child2=" + ((child2==null)?"":child2.objId+child2.getType())  + ", child3=" + ((child3==null)?"":child3.objId+child3.getType())  + ", objId="
				+ objId + ",bond1="+ cbond1 + ", edgeType=" + Arrays.toString(edgeType) + ", lbl=" + lbl + "]\n";
	}
